...
if __name__ == "__main__":
    ...
    VOCAB_SIZE = 40000
    STEPS = 1.0e6
    file_name  =  "./bouquineux_115mo.txt"
    batch_size = 48
    t = Training(VOCAB_SIZE, STEPS, batch_size, file_name)
    t.training()

"""
batch_size = 2   swap + ram = 14 Go
batch_size = 4   swap + ram = 20 Go 96 h pour STEPS = 2000000
batch_size = 8   swap + ram = 23 Go 500 h pour STEPS = 1.0e7
batch_size = 16  swap + ram = 27 Go 700 h pour STEPS = 1.0e7 GPU Mem: 3721 MB
batch_size = 32  swap + ram = 27 Go 113 h pour STEPS = 1.0e6 GPU Mem: 4387 MB
batch_size = 64  swap + ram = 12.4+15.5 = 27.9 Go --> OOM sur GPU
batch_size = 48  swap + ram = 12.7+15.5 Go 150 h STEPS = 1.0e6 GPU Mem: 5311 MB
