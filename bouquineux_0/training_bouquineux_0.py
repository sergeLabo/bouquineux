...
class Training:
    ...
    def training(self):
        ...
        **kwargs,
        ...
        # #ai.generate(1, prompt="Le soleil brille, le ciel est bleu")

if __name__ == "__main__":

    file_name  =  "./bouquineux_short.txt"
    VOCAB_SIZE = 40000
    t = Training(VOCAB_SIZE, file_name)
    t.training()

"""
Encoding 1,170,579 sets of tokens from ./bouquineux.txt
Loss: 3.062 — AvgLoss: 3.062 — Avg: 3.074 — GPU Mem: 4400 MB:
300000/300000 [32:26:29<00:00,  2.57it/s]
"""
