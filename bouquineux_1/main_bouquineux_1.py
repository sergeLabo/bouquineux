...
from irc_bouquineux_1 import RomanIrcBot
from testing_bouquineux_1 import Roman
...
CHANNEL = "#labomedia"
NICKNAME = "Classiques"
REALNAME = "du 19ème et 20ème siècle"
...
class Bidon:
    ...
    def __init__(self):
        self.num = 0
        self.quest_rep = {}
        self.quest_rep[0] = ["Jean Valjean abusa de Cosette sans état d'âme, "]
        self.alive = 1
    ...
    while bot.alive:
        ...
        if not bot.stop:
            if bot.new == 0 and bot.quest_rep:
                ...
                bot.send_pubmsg("Les Classiques auraient pu écrire:")
                sleep(5)
